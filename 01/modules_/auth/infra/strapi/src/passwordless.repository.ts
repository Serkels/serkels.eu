...
import type { Auth_Repository, Login_DTO } from "@1.modules.auth/domain";
...
@injectable()
export class Passwordless_Repository implements Auth_Repository {
